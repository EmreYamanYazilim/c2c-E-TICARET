                    ...
                    <div class="single-banner">
                        ...
                        <table id="cart" class="table table-hover table-condensed">
                            ...
                            <tr>
                                <td data-th="Product">
                                    <div class="row">
                                        <div class="col-sm-2 hidden-xs"><img style="width: 60px; height: 60px; "
                                                                             src="<?php echo $uruncek['urunfoto_resimyol']; ?>"
                                                                             alt="<?php echo $uruncek['urun_ad']; ?>"
                                ...
                                <td data-th="Subtotal"
                                    class="text-center"><?php echo $uruncek['kullanici_ad'] . " " . $uruncek['kullanici_soyad'] ?></td>
                            ...
                            <tr>
                                <td>
                                    <button onclick="geridon()" class="btn btn-warning"><i class="fa fa-angle-left"></i>
                                        Geri Dön
                                    </button>
                                </td>
                                ...
                                <form action="nedmin/netting/kullanici.php" method="POST">
                                    ...
                                    <input type="hidden" name="kullanici_idsatici"
                                           value="<?php echo $uruncek['kullanici_id'] ?>">
                                    <input type="hidden" name="urun_id" value="<?php echo $uruncek['urun_id'] ?>">
                                    <input type="hidden" name="urun_fiyat" value="<?php echo $uruncek['urun_fiyat'] ?>">

                                    <td>
                                        <button name="sipariskaydet" type="submit" class="btn btn-success btn-block">
                                            Siparişi Tamamla <i class="fa fa-angle-right"></i></button>
                                    </td>
