                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" name="urunfoto_resimyol" id="first-name"
                                               type="file">
                                    </div>
                                </div>
                                ...
                                <input type="hidden" value="<?php echo $uruncek['urunfoto_resimyol'] ?>"
                                       name="eski_yol">
                                ...
                                <div class="form-group">
                                    ...
                                    <div align="right" class="col-sm-12">
                                        <button class="update-btn" name="magazaurunduzenle" id="login-update">Ürün
                                            Düzenle
                                        </button>
