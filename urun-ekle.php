    ...
    <div class="container">
        ...
        <div class="row settings-wrapper">
            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <?php } elseif (isset($_GET['durum']) and ($_GET['durum'] == "ok")) { ?>
                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required="" name="urunfoto_resimyol" id="first-name"
                                               type="file">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required="" name="urun_ad" id="first-name"
                                               placeholder="Ürün Adı..." type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" required="" name="urun_fiyat" id="first-name"
                                               placeholder="Ürün Fiyat..." type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div align="right" class="col-sm-12">
                                        <button class="update-btn" name="magazaurunekle" id="login-update">Ürün Ekle
                                        </button>
