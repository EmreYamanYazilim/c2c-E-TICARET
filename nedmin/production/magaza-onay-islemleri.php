            ...
            $zaman=explode(" ",$kullanicicek['kullanici_zaman']);
             ...
             ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="" id="first-name" name="" disabled="" value="<?php echo $zaman[0]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="time" id="first-name" name="" disabled="" value="<?php echo $zaman[1]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="kullanici_tip" type="text" id="first-name" disabled="" name="kullanici_tip" value="<?php echo $kullanicicek['kullanici_tip'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
             ...
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="magazaonaykayit" class="btn btn-success">Başvuru Onayla</button>
                <a onclick="return confirm('mağaza başvurusunu ipal etmek istiyor musunuz ?')" class="btn btn-danger"
                   href="../netting/adminislem.php?magazaonay=red&kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>">Başvuru İptal Et</a>
