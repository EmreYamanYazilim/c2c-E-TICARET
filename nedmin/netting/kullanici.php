        ...
        if (strlen($kullanici_passwordone) >= 6) {
            ...
            if ($say == 0) {
                ...
                if ($insert) {
                    ...
                    header("Location:../../register.php?durum=kayitok");
...
if (isset($_POST['musteriadresguncelle'])) {
   ...
   ");
    ...
    if ($update) {
        ...
        header("Loacation:../../adres-bilgileri?durum=hata");
    ...
    if ($kullanici_passwordone == $kullanici_passwordtwo) {
        ...
        if (strlen($kullanici_passwordone) >= 6) {
            ...
            if ($update) {
                ...
                header("Location:../../guncelle?durum=hata");
            ...
            header("Location:../../sifre-guncelle?durum=6");
        ...
        header("Location:../../sifre-guncelle?durum=sifreuyusmuyor");
        exit;
    }
...
if (isset($_POST['sipariskaydet'])) {
    ...
    if ($insert) {
        ...
        $insertkaydet = $sipariskaydet->execute(array(
            ...
            'idsatici' => $_POST['kullanici_idsatici'],
