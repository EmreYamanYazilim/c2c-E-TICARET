...
if (isset($_POST['kullaniciresimguncelle'])) {
    ...
    //İmage Resize İşlemleri----başlagıç object orianted netting içine simgileimage olarak atılan dosya ile otomatik olarak resimlerin boyutu değiştiriliyor
    include('SimpleImage.php');
    $image = new SimpleImage();
    $image->load($tmp_name);
    $image->resize(128, 128);
