                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="corporate-address">
                            ...
                            <li><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $ayarcek['ayar_mail'] ?>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="footer-social">
                            <li><a href="<?php echo $ayarcek['ayar_facebook'] ?>"><i class="fa fa-facebook"
                                                                                     aria-hidden="true"> </i></a></li>
                            <li><a href="<?php echo $ayarcek['ayar_twitter'] ?>"><i class="fa fa-twitter"
                                                                                    aria-hidden="true"></i></a></li>
