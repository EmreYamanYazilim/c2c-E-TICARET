    ...
    <div class="registration-page-area bg-secondary section-space-bottom">
        <div class="container">
            ...
            <div class="registration-details-area inner-page-padding">
                ...
                <?php } elseif (isset($_GET['durum']) and ($_GET['durum'] == "eksiksifre")) { ?>

                    <div class="alert alert-danger">
                        <strong>Hata!</strong> Şifreniz minimum 6 karakter uzunluğunda olmalıdır.
                    </div>

                <?php } elseif (isset($_GET['durum']) and ($_GET['durum'] == "mukerrerkayit")) { ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="first-name" required="" name="kullanici_mail"
                                       placeholder="Mail Adresinizi Giriniz (Kullanıcı Adınız Olacak!)"
                                       class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="first-name" required="" placeholder="Adınızı Giriniz..."
                                       name="kullanici_ad" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label class="control-label" for="last-name">Soyadınız *</label>
                                <input type="text" id="last-name" required="" placeholder="Soyadınızı Giriniz..."
                                       name="kullanici_soyad" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="password" id="first-name" required="" placeholder="Şifrenizi Giriniz.."
                                       name="kullanici_passwordone" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="password" id="last-name" required=""
                                       placeholder="Şifrenizi Tekrar Giriniz..." name="kullanici_passwordtwo"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
