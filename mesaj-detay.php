                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding">
                                ...
                                if ($_GET['gidenmesaj'] != "ok") { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input disabled="" class="form-control" required="" name="urun_ad"
                                                   id="first-name"
                                                   value="<?php echo $mesajcek['kullanici_ad'] . " " . $mesajcek['kullanici_soyad'] ?>"
                                                   type="text">
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" name="kullanici_gel"
                                           value="<?php echo $_GET['kullanici_gon'] ?>">


                                    <div class="form-group">

                                        <div align="right" class="col-sm-12">
                                            <button class="update-btn" name="mesajcevapver" id="login-update">Mesaj
                                                Gönder
                                            </button>
